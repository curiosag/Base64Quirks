...
public class Main {
	...
	public static void main(String[] args) {
		...
		decode(new AyudaSystems(77, indexMultiplier, estimatedMaxMessageLength), msg77);
		...
		decode(new AyudaSystems(78, indexMultiplier, estimatedMaxMessageLength), msg78);
		...
		System.out.println("brute forced: " + new AyudaSystems(calibrationString, calibrationStringEncoded, (s) -> System.out.println(s)).decode(msg78[1]));		
	}
}
